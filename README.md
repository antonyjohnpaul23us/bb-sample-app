# bb-sample-app
## Just Containerizing a sicne war application and deployign it with tomcat helm chart. 
...
- This file iss used to overwrite the default values of the Bitnami Tomcat Helm chart.
- The chart takes care of deployign the following resources
-- Application Pod
-- 
